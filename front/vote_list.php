...
<div>
    <ul class='list'>
        <li class='list-header'>
            ...
            <?php
                ...
                ?>
            <div><a href="?order=multiple&type=desc<?=$p;?><?=$queryfilter;?>">單/複選題</a>
            </div>
            <?php
                }else{
                ?>
    ...
    <main>
            ...
            foreach($subjects as $subject){
                echo "<div class='wrap'>";
                echo "<div class='overlay'>{$subject['subject']}</div>";
                echo "<a href='?do=vote_result&id={$subject['id']}'>";
                if($subject['multiple']==0){
                    echo "<div class='shade' >單選題</div>";
                }else{
                    echo "<div class='shade'>複選題</div>";
                }
                ...
                echo "</div>";
                echo "<div class='info red' class='text-center'>{$subject['total']}</div>";
                echo "</a>";
                echo "</div>";
            }
